...
- **🟡 (17. Juli) — Angler ans Bild (Variante A) · Trennlinie über „Wetter" gefunden. Am Gerät ungeprüft.**
  - **Angler auf der Rekord-Karte, zweiter Anlauf.** JC zur Fassung von cc92d087: *„ist da, sieht aber
    scheisse aus."* Mockup mit drei Varianten (`mockup-angler-rekordkarte.html`), **JC hat A gewählt.**
    Das Gesicht sitzt jetzt **unten links AM Bild** statt als eigene Zeile unter dem Wert.
    - **Warum die alte Stelle nicht taugte:** Sie war eine Waise. Weil der Artname mal ein-, mal
      zweizeilig ist, saß der Avatar auf jeder Karte woanders — und die Karten wurden **unterschiedlich
      hoch**. Am Bild kostet er **keine Höhe**, also bleiben alle gleich, und er sagt ohne Worte, wer ihn
      gefangen hat. Die vierte Ecke war frei: Krone oben links, Medaille oben rechts, Gesicht unten links.
    - **JC: „aber brauch das vll einen rand?"** — Er hatte einen (2 px), und die Frage führt auf die
      Begründung: Krone und Medaille sind **einfarbige Kreise**, die trennen sich vom Foto durch die Farbe
      selbst. Der Angler ist ein **Foto auf einem Foto** — ohne Ring verschwimmt Gesicht in Gesicht.
      Deshalb trägt **nur er** einen. Der Ring ist hier keine Zierde, sondern der Grund, warum man zwei
      Bilder auseinanderhält.
    - Quer weiter der Name darunter (`.rec-who-nm`), unverändert per CSS geschaltet.
